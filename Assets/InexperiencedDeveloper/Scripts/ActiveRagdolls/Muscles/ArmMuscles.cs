...
namespace InexperiencedDeveloper.ActiveRagdoll
{
    ...
    public class ArmMuscles
    {
        ...
        public void OnFixedUpdate()
        {
            ...
            float leftExtend = player.Controls.LeftExtend;
            float rightExtend = player.Controls.RightExtend;
            bool leftGrab = player.Controls.LeftGrab;
            bool rightGrab = player.Controls.RightGrab;
